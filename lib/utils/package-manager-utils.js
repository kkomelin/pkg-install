...
exports.getPackageManagerFromLockfileSync = exports.getPackageManagerFromLockfile = exports.getCurrentPackageManager = exports.isManagerInstalledSync = exports.isManagerInstalled = void 0;
...
function getPackageManagerFromLockfile(config) {
    return __awaiter(this, void 0, void 0, function () {
        var pkgLockPath, yarnLockPath, pnpmLockPath, err_1, err_2, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pkgLockPath = path_1.default.join(config.cwd, 'package-lock.json');
                    yarnLockPath = path_1.default.join(config.cwd, 'yarn.lock');
                    pnpmLockPath = path_1.default.join(config.cwd, 'pnpm-lock.yaml');
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 12]);
                ...
                case 7:
                    _a.trys.push([7, 9, , 10]);
                    return [4 /*yield*/, access(pnpmLockPath)];
                case 8:
                    _a.sent();
...
function getPackageManagerFromLockfileSync(config) {
    ...
    var pnpmLockPath = path_1.default.join(config.cwd, 'pnpm-lock.yaml');
    try {
