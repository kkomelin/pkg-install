...
exports.projectInstallSync = exports.projectInstall = exports.installSync = exports.install = void 0;
...
function install(packages, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    config = __assign(__assign({}, config_1.defaultInstallConfig), options);
                ...
                case 2:
                    result = _b.sent();
                    return [2 /*return*/, __assign(__assign({}, result), { ignoredFlags: ignoredFlags })];
            }
        });
    });
}
...
function installSync(packages, options) {
    if (options === void 0) { options = config_1.defaultInstallConfig; }
    var config = __assign(__assign({}, config_1.defaultInstallConfig), options);
    ...
    return __assign(__assign({}, result), { ignoredFlags: ignoredFlags });
}
